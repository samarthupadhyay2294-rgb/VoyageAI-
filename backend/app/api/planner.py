...
async def generate_trip_plan(
    ...
    try:
        ...
        trip = await trip_repo.get_trip(planner_request.trip_id, current_user_id)
        ...
        # Generate trip plan
        result = await orchestrator.generate_trip_plan(trip, regenerate=planner_request.regenerate)
        ...
        return SuccessResponse(
            data=PlannerResponse(
                trip_id=planner_request.trip_id,
                status="completed",
